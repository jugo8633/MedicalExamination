...
public class TremorView extends View {
	...
	private float mSpeed = 1.0f; // 更改顯示速度(寬窄)，數字越小顯示越密;最小設1.0f。
	...
	public void addDataPoint(float value) {
		...
		mCanvas.drawLine(mLastX, mLastValue - mCenterY + 3, newX, v - mCenterY + 3,
				paint);
		mLastValue = v;
		mLastX += mSpeed;
		...
		synchronized (this) {
			if (mBitmap != null) {
				if (mLastX >= mWidth) {
					...
					mPaint.setColor(0xFFAA4444);
					cavas.drawLine(0, mCenterY, mWidth, mCenterY, mPaint);
				}
